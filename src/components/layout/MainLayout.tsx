    ...
    <div className="flex h-screen w-full bg-[#f8fafc] font-cairo overflow-hidden" dir="rtl">
      <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-2xl z-30 shrink-0 h-full">
        <div className="p-6 flex items-center gap-3 border-b border-slate-800/50">
          ...
          <div className="flex flex-col"><span className="font-black text-lg">نظام السنتر</span><span className="text-[10px] text-primary font-bold tracking-tighter uppercase">v2.0 2026</span></div>
        </div>
